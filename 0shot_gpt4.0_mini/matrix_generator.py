...
pred_path = "0shot_gpt4o_mini.xlsx"
...
print(f"Total matched records: {len(df_merged)}\n")
...
for idx, (target_name, (gt_col, pred_col)) in enumerate(targets.items()):
    ...
    ax.set_xlabel("Predicted (0-shot)", fontsize=11, fontweight='bold')
    ...
    plt.xlabel("Predicted (0-shot)", fontsize=12, fontweight='bold')
    plt.ylabel("Ground Truth", fontsize=12, fontweight='bold')
    plt.title(f"Confusion Matrix: {target_name}\n(Accuracy = {acc:.2%})", 
              fontsize=14, fontweight='bold')
    plt.tight_layout()
    plt.savefig(f"confusion_matrix_{target_name.replace(' ', '_')}.png", dpi=300, bbox_inches='tight')
    plt.close()
    
    print(f"\n✓ Saved: confusion_matrix_{target_name.replace(' ', '_')}.png")
...
print(f"\n✓ Summary saved to: accuracy_summary.csv")
...
print("\n✓ Analysis complete!")
print(f"\nGenerated Files:")
print("  1. confusion_matrix_HER2.png")
print("  2. confusion_matrix_ER.png")
print("  3. confusion_matrix_PR.png")
print("  4. confusion_matrix_Tumor_Size.png")
print("  5. confusion_matrices_all.png (combined)")
print("  6. accuracy_summary.csv")